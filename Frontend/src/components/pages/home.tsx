...
function Home() {
  ...
  const backgroundImage4 = `${process.env.PUBLIC_URL}/images/image1.jpg`;
  const backgroundImage5 = `${process.env.PUBLIC_URL}/images/banner-img-2.jpg`;
            ...
            >
              ...
              <Grid item xs={8}>
                <Typography
                  paragraph
                  align="center"
                  sx={{ color: "black", fontSize: 18, marginTop: "2%" }}
                >
